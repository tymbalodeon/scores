...
flute = \relative c' {
  ...
  <<
    ...
    { s\pp\< s\f\> s\p\< s\f\> s\pp  }
  >> |
  \time 3/4
  R2. |
  \time 4/4
  \tempo 4 = 52
  \tuplet 3/2 {d4\ppp\<(~ <d'\flageolet d,\harmonic~> <a'\flageolet d,,\harmonic~> } <d\flageolet d,,\harmonic~>8 <fs\flageolet d,,\harmonic> a c\ff)
  \time 3/4
  R2. |
  ...
  R1 |
  \tempo 4 = 52
  \tuplet 3/2 {a4\ppp\<(~ <a'\flageolet a,\harmonic~> <e'\flageolet a,,\harmonic> } a cs\ff) |
  \time 3/4
  R2. |
  \time 4/4
  \acciaccatura af,16->\sfz R1 |
  \time 3/2
  <fs'\flageolet fs,,\harmonic>8(\ppp\>~ <fs\flageolet b,,\harmonic>~ <fs\flageolet fs,\harmonic>~ <fs\flageolet b,,\harmonic>~ \tuplet 3/2 { <fs\flageolet fs,,\harmonic>2~ <fs\flageolet b,,\harmonic>~ <fs\flageolet fs,\harmonic>)\pppp } |
  \time 4/4
  R1 |
  \time 5/4
  \tempo 4 = 60
  ...
  \time 2/4
  \tempo 4 = 56
  \tuplet 3/2 { \acciaccatura a!8( as,8->\f\>) \acciaccatura a'!8( as,) \acciaccatura a'!8( as,) } \acciaccatura a''!8( as,16\pp) as as r |
  \time 1/8
  R8 |
  \time 2/4
  \xNotesOn \tuplet 3/2 { a,8\ppp r r } \tuplet 3/2 {a r r } \xNotesOff |
  R2 |
  \time 4/4
  \tempo 4 = 69
  ...
  \time 2/4
  \tempo 4 = 56
  \tuplet 3/2 { \acciaccatura gs''8( a,8->\f\>) \acciaccatura gs'8( a,) \acciaccatura gs'8( a,) } \acciaccatura gs''8( a,16->-+\pp) a,-+ a-+ r |
  \time 3/4
  \xNotesOn \tuplet 3/2 { r8 r a } \xNotesOff r4 r |
  \tempo 4 = 63
  ...
  \time 4/4
  \tempo 4 = 104
  bf'''16->\ff\>( a af g \tuplet 3/2 { fs8\f\> e d } \tuplet 5/4 { b-- gs-- e-- c-- g!--) } |
  \time 2/4
  c,4(\ppp\glissando cqf) |
  \time 3/4
  R2. |
  ...
  \time 4/4
  \tempo 4 = 108
  df'''16->\ff\>( c b bf \tuplet 3/2 { a8 g f } \tuplet 5/4 { d!-- b!-- g-- es-- bf--\pp) } |
  \time 2/4
  R2 |
  \time 3/4
  \tempo 4 = 88
  ...
  R2 |
  \time 3/4
  \xNotesOn \acciaccatura { b'16-.\pppp gs-. } \xNotesOff r4   \acciaccatura { es,16-.\fff c-. } r2 |
  \tempo 4 = 120
  \override TextSpanner.bound-details.left.text = "molto accel."
  es,8\ppp\<(\startTextSpan f gf es f gf)\stopTextSpan
  \time 6/8
  \tuplet 4/6 { es16( f \acciaccatura d''-> gf,, es } \tuplet 4/6 { f gf \acciaccatura d''-> es,, f) } |
  \time 3/4
  \acciaccatura d''16-> \tuplet 3/2 { gf,,8( es \acciaccatura gf''16-> f,,8 }  \tuplet 3/2 { gf8 es \acciaccatura gf''16-> f,,8 }  \tuplet 3/2 { gf8 es f) } |
  \time 4/4
  \acciaccatura a''16-> es,16( f gf es \tuplet 5/4 { f \acciaccatura a'-> gf, es f \acciaccatura b'-> gf, } \tuplet 3/2 { es f gf } \tuplet 3/2 { es f \acciaccatura b'-> gf,\f) } r4 |
  \tempo 4 = 80
  \tuplet 3/2 { d,16\pp\<( a' fs } \tuplet 3/2 { cs' bf f'! } d32 af' f b! fs c'! a! ds \tuplet 5/4 { c e f gf e } \tuplet 7/4 { g a bf gs b! cs d\ff) } r4 |
  \time 3/4
  \tempo 4 = 76
  ...
  \time 3/4
  \tempo 4 = 54
  \acciaccatura d16->\sfz \tuplet 3/2 { cs,,,4\pp\glissando cqs\glissando c! } r4 |
  \time 2/4
  \acciaccatura fs''16->\sfz
  R2 |
  \time 3/4
  \tempo 4 = 72
  \tuplet 3/2 {as16\ff\>-> r gs-> r fs-> r} \tuplet 5/4 {ds-> r c-> r gs-> r e-> r b-> r} |
  \time 3/4
  e,4\ppp r r |
  \time 2/4
  \tempo 4 = 63
  \tuplet 3/2 { \acciaccatura b''8 c,8\ppp-> \acciaccatura b' c, \acciaccatura b' c, } \acciaccatura b'' c,16 c r8 |
  \time 4/4
  \tempo 4 = 116
  d'32\fff\>-> r df-> r c-> r b-> r \tuplet 3/2 {as16-> r gs-> r fs-> r } \tuplet 5/4 { ds-> r c-> r gs-> r e-> r b-> r } |
  \time 3/4
  e,4\ppp r r |
  \time 2/8
  \tempo 4 = 66
  \tuplet 3/2 { \acciaccatura g'!8 gs,\pppp-> \acciaccatura g'! gs, \acciaccatura g'! gs, } |
  \time 3/4
  \tempo 4 = 76
  \tuplet 3/2 {gs''16\f\>-> r fs-> r e-> r} \tuplet 5/4 {cs-> r bf-> r fs-> r d-> r a\ppp-> r} |
  \time 2/4
  R2 |
  \tempo 4 = 88
  \time 5/8
  ...
  \time 3/4
  \tempo 4=84
  \tuplet 3/2 {fs16\f\>->-+ r e-+ r d-+ r} \tuplet 5/4 {b-+ r gs-+ r e-+ r c-+ r g-+ r} |
  \time 2/4
  c,4(\ppp\glissando cqf) |
  R2 |
  \tempo 4=104
  \time 4/4
  bf'''32\ff\>-> r a r af r g r \tuplet 3/2 {fs16 r e r d r } \tuplet 5/4 {\xNotesOn b r gs r e r c r g r \xNotesOff } |
  \time 3/4
  c,4(\ppp\glissando cqf) r |
  \tempo 4=132
  \time 5/4
  \tuplet 3/2 {d'''16->\fff\>( df c} \tuplet 3/2 {b bf a)} af32-> r g-> r gf-> r f-> r \tuplet 3/2 {e16-> r d-> r c-> r } \tuplet 5/4 {a-+ r fs-+ r d-+ r bf-+ r f\pppp-+ r } |
  \time 3/4
  R2. |
  \tempo 4=100
  \time 4/4
  fs4\ppp\<( a c  ef |
  \time 7/8
  \tuplet 3/2 { fs8 gs as } \tuplet 3/2 { c d e } \tuplet 5/4 { fs16 g gs a as } \tuplet 3/2 { b c cs\f) } |
  \time 2/4
  R2 |
  ...
  \tempo 4=76
  \time 3/4
                                % how to make decrescendo in the line below?
  ...
  \tempo 4=88
  \time 4/4
  \tuplet 5/4 { d,,8--->\pppp\<( f-- af-- c-- d-- } \tuplet 3/2 { fs as d } e16 fs gs as) |
\tempo 4=132
