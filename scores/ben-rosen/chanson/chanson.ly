...
upper_staff =  \relative fs' {
  ...
  % measure 4
  as fs ds gs, )
  \tuplet 6/4  { as ( cs ds, \change Staff="lower" cs as fs ) }
  \change Staff="upper" |
  ...
  % measure 6
  s1. -\p fs''16 ( es cs gs \change Staff="lower" b,
  \change Staff="upper" cs as fs ) |
  ...
  \clef "treble"
  gs' -\< ds
  es as gs fs ds cs8 ~ cs ) -\! <ds e gs>8 -_ -\f r4 |
  ...
  % measure 9
  \time 2/2  <ds e fs b>8 _\mp s4. r2 \change
  Staff="lower" |1

  % measure 10
  gs,,16 e,16 \change Staff="upper" b'''16 ( ds,16 ) r16 fs'16 ( cs'16 as16
  ) r16 as,16 ( ds,16 cs16 ) r8. <b' as'>16 ( ~ |2

  % measure 11
  <b ds gs>16 ) -. <gs cs>16 ( <as b>16 fs'16 ) \once \omit
  TupletBracket
  \times 4/6  {
    ds16 ( as16 e16 fss16 \change Staff="lower" cs16 ds,16 ) }
  \change Staff="upper" r4 <gf' a df>4 \bar "||"

  % measure 12
  \key df \major \change Staff="lower" bf,,16 ( -\! _\markup{
    \italic {sub.} } _\mp -\< g'16 c16 \change Staff="upper" f16
  bf16 ef16 a16 f16 g16 df16 g,16 f16 \clef "bass" ef16 af,16 bf16 ef,16
  ) |4

  % measure 13
  \clef "treble" <g c f a>4 -- _\mf <f' af c>4 ( _\markup{
    \italic {sub.} } _\p _\< <af df>4 <a c af'>4 _\! _\markup{
      \italic {espressivo} } |5

  % measure 14
  <a ef'>4 _\mf <af af'>4 gf'16 f16 c16 df16 <c ef>4 \change Staff="lower"
  |6%}

  % measure 15
  bf,,16 \change Staff="upper" c'16 a16 ef'16 df16 g,16 f'8 g16 af16 <f
                                                                      bf>8 <c d f a>4 ) \bar "||"

  % measure 16
  \key c \minor <ef f a>1 ~ ~ ~ _\mp |8
  ...
  \time 4/4  <gf af df f>2 r4 _\! \clef "treble"
  <df' f gf af>4 \arpeggio -_ \arpeggio \arpeggio \arpeggio |1
...
lower_staff_two =  \relative cs' {
    \clef "bass" \time 2/2 \key b \major |
    r8 cs8 ds8 gs,8 fs2 \change Staff="upper" \change Staff="lower" _\markup{
        \italic {esspressivo} } |
