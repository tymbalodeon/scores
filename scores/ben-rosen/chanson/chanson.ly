...
upper_staff_two =  \relative ds' {
    ...
    \key df \major s2. \clef "bass" s4 |
    \clef "treble" \change Staff = "upper" s1 |
    df'8 ( b8 ef8 df8 ) <a c>4 f16 df16 af'16 ef16 s1 \bar "||"
    \key c \minor s2 r4 <ef' f d'>4 |
    \time 5/4  s4*5 \bar "||"
    \clef "bass" \time 6/4 \key ef \minor s1 f,,2 | \barNumberCheck #20
    \time 4/4  s2. \clef "treble" s4 |
    r8 <af bf>8 \times 2/3 {
        af4 bf8 }
    r8 <af bf>8 \times 2/3 {
        af4 bf8 }
    ...
    \times 2/3 {
        gs'4 fs8 }
    |
    r8 <fs, b ds>8 r4 r8 e'8 r4 s1 s1 s1 |
    \time 3/4  r8 <as,, b ds fs>8 ~ ~ ~ ~ <as b ds fs>2 |
    \time 4/4  as''16 gs16 fs16 b,16 cs16 as16 gs16
    fs16 cs16 ds16 <b ds>8 ~ ~ <b ds>4 |
    \time 5/4  s2. \clef "bass" s2 |
    \time 2/2  s1 |
...
%             calmando} } \clef "treble" r8 b8 r8 r8 cs,16 ds16 |
...
%     g,16 |
%     <ef bf'>4 -- <df'' ef>4 <f, bf ef>4 <ef df'>4 |
%     <gf df'>4 <f df'>4 <f ef'>4 <cf a'>4 s4 r8 df16 af'16 c16 bf16 g16 a16
%     <ef g bf>8 d8 \bar "||"
%     \key c \minor <c g' bf>1 ~ ~ ~ \clef "treble" |
...
%     \ottava #-1 ef,2 |
%     df''8 ef,8 gf'8 f8 df8 ef,8 gf'8 f8 |
%     bf,8 ef,8 gf'8 f8 ef8 bf8 gf8 f8 |
%     ff8 df'8 cf8 _\< gf'8 ff8 df8 r8 <d, a'>8 ~ ~ _\! _\f |
%     \time 3/4  <a' d>4 <fs cs'>2 \bar "||"
%     \time 4/4  \key gs \minor e'8 fs,8 cs''8 gs8 e8
%     fs,8 cs''8 gs8 |
%     \time 2/4  e8 fs,8 cs''8 fs,8 |
%     \time 4/4  e16 cs,16 ds'8 cs8 a8 b8 cs,8 e'8 ds8
%     |
%     b8 cs,8 e'8 ds8 gs,8 cs,8 e'8 ds8 s2 r8 <e b'>8 s4 s1 |
%     r8 as8 ~ as4 ~ as4 <e as cs>4 |
...
%     as16 fs8 gs8 |
%     \time 2/2  \change Staff = "lower" cs,,2. r4 |
%     r8 ds'8 ~ ds2. ~ |
%     <gs, ds'>2 r2 \bar "|."
%     }
...
lower_staff_two =  \relative cs' {
    ...
    <a gs'>8 <b gs'>4 <cs b'>8 ~ ~ <cs b'>4 <ds as' fs'>4 |
    e,2 ~ \times 2/3 {
        e4 <cs gs'>8 ~ ~ }
    <cs gs'>4 |
    \time 3/4  s2 \clef "treble" as'''8 ds8 |
    \time 4/4  s8 \clef "bass" s8*7 |
...
PartPTwoVoiceSeven =  \relative g' {
    ...
    \time 4/4  \key gs \minor s1 |
    \time 2/4  s2 |
    \time 4/4  s1 s1*2 s1 s1 |
    \time 3/4  s2 \clef "treble" s4 |
    \time 4/4  s8 \clef "bass" s8*7 |
    \time 5/4  s4. \clef "treble" s4. \clef "bass" s2 |
    \time 2/2  s1*3 \bar "|."
    }
...
PartPTwoVoiceThree =  \relative as''' {
    ...
    \time 4/4  s2. \clef "treble" s4 s1*2 s1 |
    \time 3/4  s2. \bar "||"
    \time 4/4  \key gs \minor s1 |
    \time 2/4  s2 |
    \time 4/4  s1 s1*2 s1 s1 |
